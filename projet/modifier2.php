...
echo "<table  class='table table-striped table-bordered table-hover' id='dataTables-example'>";
 echo "<thead><tr><th width=50px >Id</th><th width=50px >Priorité</th><th width=50px>Date de creation</th><th width=50px>Donnée par</th><th width=50px>Objet</th><th width=50px>Détails</th><th width=50px>Situation</th><th width=50px >Date limite</th><th width=50px>Realisée par</th><th width=50px>Modifier</th></tr></thead><tbody>";
...
echo "<td width=50px>
<a href='modif2.php?dd=$item[0]'><i style ='font-size: 25px ; color:#E34234' class='fa fa-edit'></i></a>
</td></tr>";
}
