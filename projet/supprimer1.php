...
echo "<table  class='table table-striped table-bordered table-hover' id='dataTables-example'>";
 echo "<thead><tr><th width=50px >id</th><th width=50px >Nom</th><th width=50px>Profil</th><th width=50px>Département</th><th width=50px>E-mail</th><th width=50px>Supprimer</th></tr></thead><tbody>";
...
echo "<td width=50px>
<a href='supp1.php?dd=$item[0]'><i style ='font-size: 25px ; color:#E34234' class='fa fa-trash'></i></a>
</td></tr>";
}
