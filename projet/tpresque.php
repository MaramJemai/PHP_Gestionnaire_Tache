...
?>
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Taches presque expirées</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
...
require_once("tache.php");
 $tache = new tache ();
 if($id != 1):
    $les_taches=$tache->edits31($id);
else : 
    $les_taches=$tache->edits3();
endif;
...
echo "<table  class='table table-striped table-bordered table-hover' id='dataTables-example'>";
 echo "<thead><tr><th width=50px >Id</th><th width=50px >Priorité</th><th width=50px>Date de création</th><th width=50px>Donnée par</th><th width=50px>Objet</th><th width=50px>Détails</th><th width=50px>Situation</th><th width=50px >Date limite</th><th width=50px >Réaliser par</th></tr></thead><tbody>";
